...
@NgModule({
    ...
    providers: [
        ...
        PRO_NCVKhacCustomProvider, PRO_LLKHCustomProvider, PRO_SYLLCustomProvider, STAFF_NhanSu_SYLLProviderCustomProvider,
        ...
        HRM_BenhNhanProvider, STAFF_NhanSu_LLKHProvider, PRO_LLKHProvider, STAFF_NhanSu_SYLLProvider, PRO_SYLLProvider
    ]
})
