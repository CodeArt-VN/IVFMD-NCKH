...
import {
    ...
    PRO_BangKiemXXDDProvider, PRO_AE, PRO_PhieuXemXetDaoDuc, PRO_SAE, PRO_BaoCaoNangSuatKhoaHocProvider, PRO_HoiNghiHoiThaoProvider, PRO_HoiNghiHoiThaoDangKyProvider, PRO_ThuyetMinhDeTai, STAFF_NhanSu_HosremProvider
...
@NgModule({
    ...
    providers: [
        ...
        DOC_FileProvider, DOC_File_ActitityProvider, DOC_File_PermissionProvider, DOC_FileInFolderProvider, DOC_FolderProvider, DOC_Folder_ActivityProvider, DOC_Folder_PermissionProvider, HRM_LIST_BoPhanProvider, HRM_LIST_ChucDanhProvider, HRM_STAFF_NhanSuProvider, SYS_CauHinhHeThongProvider, SYS_PermissionListProvider, SYS_PermissionListDetailDataProvider, SYS_RoleProvider, VersionProvider, PAR_DonHangProvider, PAR_DonHang_ChiTietProvider, PAR_PartnerProvider, PAR_ThongTinSanPhamProvider, PROD_SanPhamProvider, PROD_SanPham_ChiTietProvider, SYS_AppsProvider, SYS_ConfigProvider, SYS_ControllerActionsProvider, SYS_FormProvider, SYS_FormDetailProvider, SYS_FormGroupProvider, WEB_BaiVietProvider, WEB_BaiViet_DanhMucProvider, WEB_BaiViet_TagProvider, WEB_DanhMucProvider, WEB_TagProvider, CAT_TagsProvider, CAT_NhomProvider, CAT_KinhPhiProvider, CAT_BangGiaKinhPhiProvider, CAT_ThietLapThoiGianBaoCaoNSKHProvider, CAT_ThietLapThoiGianBaoCaoTDNCProvider, CAT_ThietLapTemplateProvider, CAT_SiteProvider, PRO_DeTaiProvider, PRO_BenhNhanProvider, PRO_NCVKhacProvider,
        HRM_BenhNhanProvider, STAFF_NhanSu_LLKHProvider, PRO_LLKHProvider, STAFF_NhanSu_SYLLProvider, PRO_SYLLProvider, PRO_BangKiemXXDDProvider, PRO_AE, PRO_PhieuXemXetDaoDuc, PRO_SAE, PRO_BaoCaoNangSuatKhoaHocProvider, PRO_BaoCaoNangSuatKhoaHocCustomProvider, PRO_HoiNghiHoiThaoProvider, PRO_HoiNghiHoiThaoCustomProvider, PRO_HoiNghiHoiThaoDangKyProvider, PRO_HoiNghiHoiThaoDangKyCustomProvider, PRO_ThuyetMinhDeTai, STAFF_NhanSu_HosremProvider
    ]
})
