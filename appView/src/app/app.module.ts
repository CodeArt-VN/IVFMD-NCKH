...
@NgModule({
    ...
    providers: [
        ...
        ManualProvider, ReportProvider, Sys_VarProvider, PRO_SysnopsisCustomProvider, PRO_MauPhanTichDuLieuCustomProvider, PRO_DonXinXetDuyetCustomProvider, PRO_DonXinDanhGiaDaoDucCustomProvider, PRO_DonXinNghiemThuCustomProvider, PRO_BenhNhanCustomProvider, PRO_NCVKhacCustomProvider,
