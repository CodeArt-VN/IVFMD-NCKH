...
@NgModule({
    ...
    providers: [
        ...
        ManualProvider, ReportProvider, Sys_VarProvider, PRO_SysnopsisCustomProvider, PRO_MauPhanTichDuLieuCustomProvider, PRO_DonXinXetDuyetCustomProvider, PRO_DonXinDanhGiaDaoDucCustomProvider, PRO_DonXinNghiemThuCustomProvider, PRO_BenhNhanCustomProvider, PRO_NCVKhacCustomProvider, STAFF_NhanSu_LLKHProviderCustomProvider,
        ...
        HRM_BenhNhanProvider, STAFF_NhanSu_LLKHProvider
