...
@IonicPage({ name: 'page-tags', segment: 'tags', priority: 'high' }) 
@Component({ selector: 'page-tags', templateUrl: 'tags.html' })
export class TagsPage extends ListPage {
    ...
    constructor(
        ...
        super('page-tags', '', currentProvider, navCtrl, navParams, events, toastCtrl, loadingCtrl, alertCtrl, commonService, accountService);
    ...
    openDetail(item) {
        let myModal = this.modalCtrl.create(TagsModalPage, { 'id': item.ID });
        myModal.present();
    }
    add() {
        let item = {
