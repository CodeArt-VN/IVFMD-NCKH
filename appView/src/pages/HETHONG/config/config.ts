...
export class ConfigPage {
    ...
    slides = [
		{
			...
			image: "./assets/imgs/config/ica-slidebox-img-1.png",
		},
		{
			...
			image: "./assets/imgs/config/ica-slidebox-img-2.png",
		},
		{
			...
			image: "./assets/imgs/config/ica-slidebox-img-3.png",
		}
    ];
    goToEnd() {
    ...
    ionViewDidLoad() {
        this.events.publish('app:changeMenu', "page-config");
