...
export var appSetting = {
	mainService: {
        ...
        //base: "http://myduc.appcenter.vn:9004/",
        
        //base: "http://10.211.55.6:54009/",
		api: "api/",
	},
...
export var APIListBase = {
    ...
    PRO_DeTai:{
        ...
        print: {
            method: "POST",
            url: function(){return appSetting.apiDomain("PRO/DeTai/print2")}
        },
        uploadFile: {
            method: "POST",
    ...
    PRO_ThuyetMinhDeTai: {
        ...
        uploadFileThuyetMinh: {
            method: "POST",
            url: function (id, path) { return appSetting.apiDomain("PRO/ThuyetMinhDeTai/uploadFileThuyetMinh/") }
        },
    },
    PRO_BangKhaiNhanSu: {
        getList: {
