...
{
    [RoutePrefix("api/CAT/ThietLapTemplate")]
    public class ThietLapTemplateController : CustomApiController
    {
        [Route("")]
        ...
        public IHttpActionResult Post(DTO_SYS_Config tbl_SYS_Config)
        {
            ...
            DTO_SYS_Config result = BS_SYS_Config.post_SYS_Config_Template(db, tbl_SYS_Config, Username);
