...
namespace ClassLibrary
{
    ...
    public partial class tbl_CUS_HRM_STAFF_NhanSu_LLKH
    {
...
namespace BaseBusiness
{
    ...
    {
		public static IQueryable<DTO_CUS_HRM_STAFF_NhanSu_LLKH> toDTO(IQueryable<tbl_CUS_HRM_STAFF_NhanSu_LLKH> query)
        {
			return query
			.Select(s => new DTO_CUS_HRM_STAFF_NhanSu_LLKH(){							
				ID = s.ID,							
				IDNhanSu = s.IDNhanSu,							
				ImageURL = s.ImageURL,							
				HoTen = s.HoTen,							
		...
		public static DTO_CUS_HRM_STAFF_NhanSu_LLKH toDTO(tbl_CUS_HRM_STAFF_NhanSu_LLKH dbResult)
        {
			if (dbResult != null)
			{
				return new DTO_CUS_HRM_STAFF_NhanSu_LLKH()
				{							
					ID = dbResult.ID,							
		...
		public static bool put_CUS_HRM_STAFF_NhanSu_LLKH(AppEntities db, int ID, DTO_CUS_HRM_STAFF_NhanSu_LLKH item, string Username)
        {
            ...
            {							
                ...
                {
					errorLog.logMessage("put_CUS_HRM_STAFF_NhanSu_LLKH",e);
                    result = false;
                }
            }
            return result;
		...
		public static DTO_CUS_HRM_STAFF_NhanSu_LLKH post_CUS_HRM_STAFF_NhanSu_LLKH(AppEntities db, DTO_CUS_HRM_STAFF_NhanSu_LLKH item, string Username)
        {
            ...
            {							
                ...
                {
					errorLog.logMessage("post_CUS_HRM_STAFF_NhanSu_LLKH",e);
                    item = null;
                }
            }
            return item;
		...
		public static bool delete_CUS_HRM_STAFF_NhanSu_LLKH(AppEntities db, int ID, string Username)
        {
			bool result = false;
            var dbitem = db.tbl_CUS_HRM_STAFF_NhanSu_LLKH.Find(ID);
            if (dbitem != null)
            {
                ...
                {
					errorLog.logMessage("delete_CUS_HRM_STAFF_NhanSu_LLKH",e);
                    result = false;
                }
            }
            return result;
		...
		public static bool check_CUS_HRM_STAFF_NhanSu_LLKH_Exists(AppEntities db, int id)
		{
			return db.tbl_CUS_HRM_STAFF_NhanSu_LLKH.Any(e => e.ID == id);
		}
