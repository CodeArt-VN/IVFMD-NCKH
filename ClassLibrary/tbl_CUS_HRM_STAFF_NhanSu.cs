...
namespace BaseBusiness
{
    ...
    public static partial class BS_CUS_HRM_STAFF_NhanSu 
    {
        ...
        {
			var query = db.tbl_CUS_HRM_STAFF_NhanSu.Where(d => d.IsDeleted == false && d.IDPartner == PartnerID);
        ...
        {
            var dbResult = db.tbl_CUS_HRM_STAFF_NhanSu.FirstOrDefault(d => d.IsDeleted == false && d.IDPartner == PartnerID && d.Code == code);
			if (dbResult == null || dbResult.IDPartner != PartnerID)
				return null; 
			else 
				return toDTO(dbResult);
