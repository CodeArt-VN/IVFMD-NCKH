...
namespace ClassLibrary
{
    ...
    public partial class tbl_CUS_HRM_LIST_BoPhan
    {
...
{
	using System;
	public partial class DTO_CUS_HRM_LIST_BoPhan
	{
		public int IDPartner { get; set; }
		public int ID { get; set; }
		public string Code { get; set; }
...
namespace BaseBusiness
{
    ...
    public static partial class BS_CUS_HRM_LIST_BoPhan 
    {
		public static IQueryable<DTO_CUS_HRM_LIST_BoPhan> toDTO(IQueryable<tbl_CUS_HRM_LIST_BoPhan> query)
        {
			return query
			.Select(s => new DTO_CUS_HRM_LIST_BoPhan(){							
		...
		public static DTO_CUS_HRM_LIST_BoPhan toDTO(tbl_CUS_HRM_LIST_BoPhan dbResult)
        {
			if (dbResult != null)
			{
				return new DTO_CUS_HRM_LIST_BoPhan()
				{							
		...
		public static DTO_CUS_HRM_LIST_BoPhan get_CUS_HRM_LIST_BoPhan(AppEntities db, int PartnerID, int id)
        {
            var dbResult = db.tbl_CUS_HRM_LIST_BoPhan.Find(id);
		...
		public static bool put_CUS_HRM_LIST_BoPhan(AppEntities db, int PartnerID, int ID, DTO_CUS_HRM_LIST_BoPhan item, string Username)
        {
            bool result = false;
            var dbitem = db.tbl_CUS_HRM_LIST_BoPhan.Find(ID);
            if (dbitem != null)
            {							
                ...
                try
                {
					...
					BS_CUS_Version.update_CUS_Version(db, dbitem.IDPartner, "DTO_CUS_HRM_LIST_BoPhan", dbitem.ModifiedDate, Username);
                ...
                {
					errorLog.logMessage("put_CUS_HRM_LIST_BoPhan",e);
                    result = false;
                }
            }
            return result;
		...
		public static DTO_CUS_HRM_LIST_BoPhan post_CUS_HRM_LIST_BoPhan(AppEntities db, int PartnerID, DTO_CUS_HRM_LIST_BoPhan item, string Username)
        {
            tbl_CUS_HRM_LIST_BoPhan dbitem = new tbl_CUS_HRM_LIST_BoPhan();
            if (item != null)
            {							
				dbitem.Code = item.Code;							
				dbitem.Name = item.Name;							
                ...
                try
                {
					db.tbl_CUS_HRM_LIST_BoPhan.Add(dbitem);
                    db.SaveChanges();
                ...
                {
					errorLog.logMessage("post_CUS_HRM_LIST_BoPhan",e);
                    item = null;
                }
            }
            return item;
		...
		public static bool delete_CUS_HRM_LIST_BoPhan(AppEntities db, int ID, string Username)
        {
			bool result = false;
            var dbitem = db.tbl_CUS_HRM_LIST_BoPhan.Find(ID);
            if (dbitem != null)
            {
                ...
                {
					errorLog.logMessage("delete_CUS_HRM_LIST_BoPhan",e);
                    result = false;
                }
            }
            return result;
		...
		public static bool check_CUS_HRM_LIST_BoPhan_Exists(AppEntities db, int id)
		{
			return db.tbl_CUS_HRM_LIST_BoPhan.Any(e => e.ID == id);
		}
		
		public static bool check_CUS_HRM_LIST_BoPhan_Exists(AppEntities db, string Code)
		{
			return db.tbl_CUS_HRM_LIST_BoPhan.Any(e => e.Code == Code);
		}
