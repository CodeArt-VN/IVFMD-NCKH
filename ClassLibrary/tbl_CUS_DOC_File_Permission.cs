...
namespace ClassLibrary
{
    ...
    public partial class tbl_CUS_DOC_File_Permission
    {
...
{
	using System;
	public partial class DTO_CUS_DOC_File_Permission
	{
		public int IDPartner { get; set; }
		public int IDFile { get; set; }
		public int IDRole { get; set; }
...
namespace BaseBusiness
{
    ...
    public static partial class BS_CUS_DOC_File_Permission 
    {
		public static IQueryable<DTO_CUS_DOC_File_Permission> toDTO(IQueryable<tbl_CUS_DOC_File_Permission> query)
        {
			return query
			.Select(s => new DTO_CUS_DOC_File_Permission(){							
		...
		public static DTO_CUS_DOC_File_Permission toDTO(tbl_CUS_DOC_File_Permission dbResult)
        {
			if (dbResult != null)
			{
				return new DTO_CUS_DOC_File_Permission()
				{							
        ...
        public static IQueryable<DTO_CUS_DOC_File_Permission> get_CUS_DOC_File_Permission(AppEntities db, int PartnerID, Dictionary<string, string> QueryStrings)
        {
			var query = db.tbl_CUS_DOC_File_Permission.Where(d => d.IsDeleted == false && d.IDPartner == PartnerID);
		...
		public static DTO_CUS_DOC_File_Permission get_CUS_DOC_File_Permission(AppEntities db, int PartnerID, int id)
        {
            var dbResult = db.tbl_CUS_DOC_File_Permission.Find(id);
		...
		public static DTO_CUS_DOC_File_Permission post_CUS_DOC_File_Permission(AppEntities db, int PartnerID, DTO_CUS_DOC_File_Permission item, string Username)
        {
            tbl_CUS_DOC_File_Permission dbitem = new tbl_CUS_DOC_File_Permission();
            if (item != null)
            {							
				dbitem.IDFile = item.IDFile;							
				dbitem.IDRole = item.IDRole;							
                ...
                try
                {
					db.tbl_CUS_DOC_File_Permission.Add(dbitem);
                    db.SaveChanges();
                ...
                {
					errorLog.logMessage("post_CUS_DOC_File_Permission",e);
                    item = null;
                }
            }
            return item;
		...
		public static bool delete_CUS_DOC_File_Permission(AppEntities db, int ID, string Username)
        {
			bool result = false;
            var dbitem = db.tbl_CUS_DOC_File_Permission.Find(ID);
            if (dbitem != null)
            {
                ...
                {
					errorLog.logMessage("delete_CUS_DOC_File_Permission",e);
                    result = false;
                }
            }
            return result;
		...
		public static bool check_CUS_DOC_File_Permission_Exists(AppEntities db, int id)
		{
			return db.tbl_CUS_DOC_File_Permission.Any(e => e.ID == id);
		}
