...
namespace BaseBusiness
{
    ...
    public static partial class BS_PRO_Tags 
    {
        ...
        public static IQueryable<DTO_PRO_Tags> get_PRO_Tags(AppEntities db, int PartnerID, Dictionary<string, string> QueryStrings)
        {
			var query = db.tbl_PRO_Tags
		...
		public static DTO_PRO_Tags get_PRO_Tags(AppEntities db, int PartnerID, int id)
        {
		...
		public static bool put_PRO_Tags(AppEntities db, int PartnerID, int ID, DTO_PRO_Tags item, string Username)
        {
            bool result = false;
            ...
            {							
                ...
                try
                {
					...
					BS_CUS_Version.update_CUS_Version(db, null, "DTO_PRO_Tags", dbitem.ModifiedDate, Username);
		...
		public static DTO_PRO_Tags post_PRO_Tags(AppEntities db, int PartnerID, DTO_PRO_Tags item, string Username)
        {
