...
namespace ClassLibrary
{
    ...
    public partial class tbl_PRO_DonXinNghiemThu
    {
        ...
        public string NgayKy_ChuKyThuTruong { get; set; }
...
namespace BaseBusiness
{
    ...
    public static partial class BS_PRO_DonXinNghiemThu 
    {
        ...
        public static IQueryable<DTO_PRO_DonXinNghiemThu> get_PRO_DonXinNghiemThu(AppEntities db, Dictionary<string, string> QueryStrings)
        {
			...
			//Query NgayKy_ChuKyThuTruong (string)
			if (QueryStrings.Any(d => d.Key == "NgayKy_ChuKyThuTruong") && !string.IsNullOrEmpty(QueryStrings.FirstOrDefault(d => d.Key == "NgayKy_ChuKyThuTruong").Value))
            {
                var keyword = QueryStrings.FirstOrDefault(d => d.Key == "NgayKy_ChuKyThuTruong").Value;
                query = query.Where(d=>d.NgayKy_ChuKyThuTruong == keyword);
            }
		...
		public static DTO_PRO_DonXinNghiemThu get_PRO_DonXinNghiemThu(AppEntities db, int id)
        {
		...
		public static DTO_PRO_DonXinNghiemThu post_PRO_DonXinNghiemThu(AppEntities db, DTO_PRO_DonXinNghiemThu item, string Username)
        {
