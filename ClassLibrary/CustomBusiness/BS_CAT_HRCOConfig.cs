...
namespace BaseBusiness
{
    ...
    {
        public static IQueryable<DTO_CAT_HRCOConfig> get_CAT_HRCOConfigCustom(AppEntities db, Dictionary<string, string> QueryStrings)
        {
            var query = db.tbl_CAT_HRCOConfig.AsQueryable();
        ...
        public static IQueryable<DTO_CAT_HRCOConfig> toDTOCustom(IQueryable<tbl_CAT_HRCOConfig> query)
        {
            return query
