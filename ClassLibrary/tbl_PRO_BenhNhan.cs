...
namespace ClassLibrary
{
    ...
    public partial class tbl_PRO_BenhNhan
    {
...
{
	using System;
	public partial class DTO_PRO_BenhNhan
	{
		public int ID { get; set; }
		public int IDDeTai { get; set; }
		public int IDBenhNhan { get; set; }
...
namespace BaseBusiness
{
    ...
    {
		public static IQueryable<DTO_PRO_BenhNhan> toDTO(IQueryable<tbl_PRO_BenhNhan> query)
        {
			return query
		...
		public static DTO_PRO_BenhNhan toDTO(tbl_PRO_BenhNhan dbResult)
        {
			if (dbResult != null)
			{
		...
		public static bool put_PRO_BenhNhan(AppEntities db, int PartnerID, int ID, DTO_PRO_BenhNhan item, string Username)
        {
            ...
            {							
                ...
                try
                {
					...
					BS_CUS_Version.update_CUS_Version(db, null, "DTO_PRO_BenhNhan", dbitem.ModifiedDate, Username);
		...
		public static bool delete_PRO_BenhNhan(AppEntities db, int ID, string Username)
        {
			bool result = false;
            var dbitem = db.tbl_PRO_BenhNhan.Find(ID);
            if (dbitem != null)
            {
                ...
                {
					errorLog.logMessage("delete_PRO_BenhNhan",e);
                    result = false;
                }
            }
            return result;
		...
		public static bool check_PRO_BenhNhan_Exists(AppEntities db, int id)
		{
			return db.tbl_PRO_BenhNhan.Any(e => e.ID == id);
		}
