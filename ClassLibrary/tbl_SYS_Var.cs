...
namespace ClassLibrary
{
    ...
    public partial class tbl_SYS_Var
    {
        ...
        public string TypeOfVar { get; set; }
...
namespace BaseBusiness
{
    ...
    public static partial class BS_SYS_Var 
    {
        ...
        public static IQueryable<DTO_SYS_Var> get_SYS_Var(AppEntities db, int PartnerID, Dictionary<string, string> QueryStrings)
        {
			...
			//Query TypeOfVar (string)
			if (QueryStrings.Any(d => d.Key == "TypeOfVar") && !string.IsNullOrEmpty(QueryStrings.FirstOrDefault(d => d.Key == "TypeOfVar").Value))
            {
                var keyword = QueryStrings.FirstOrDefault(d => d.Key == "TypeOfVar").Value;
                query = query.Where(d=>d.TypeOfVar == keyword);
            }
