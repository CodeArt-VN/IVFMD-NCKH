...
namespace ClassLibrary
{
    ...
    public partial class tbl_CUS_HRM_LIST_ChucDanh
    {
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
        public tbl_CUS_HRM_LIST_ChucDanh()
        {
...
{
	using System;
	public partial class DTO_CUS_HRM_LIST_ChucDanh
	{
		public Nullable<int> IDPartner { get; set; }
		public Nullable<int> IDBoPhan { get; set; }
		public int ID { get; set; }
...
namespace BaseBusiness
{
    ...
    public static partial class BS_CUS_HRM_LIST_ChucDanh 
    {
		public static IQueryable<DTO_CUS_HRM_LIST_ChucDanh> toDTO(IQueryable<tbl_CUS_HRM_LIST_ChucDanh> query)
        {
			return query
			.Select(s => new DTO_CUS_HRM_LIST_ChucDanh(){							
		...
		public static DTO_CUS_HRM_LIST_ChucDanh toDTO(tbl_CUS_HRM_LIST_ChucDanh dbResult)
        {
			if (dbResult != null)
			{
				return new DTO_CUS_HRM_LIST_ChucDanh()
				{							
		...
		public static DTO_CUS_HRM_LIST_ChucDanh get_CUS_HRM_LIST_ChucDanh(AppEntities db, int PartnerID, int id)
        {
            var dbResult = db.tbl_CUS_HRM_LIST_ChucDanh.Find(id);
		...
		public static DTO_CUS_HRM_LIST_ChucDanh post_CUS_HRM_LIST_ChucDanh(AppEntities db, int PartnerID, DTO_CUS_HRM_LIST_ChucDanh item, string Username)
        {
            tbl_CUS_HRM_LIST_ChucDanh dbitem = new tbl_CUS_HRM_LIST_ChucDanh();
            if (item != null)
            {							
				dbitem.IDBoPhan = item.IDBoPhan;							
				dbitem.Code = item.Code;							
                ...
                try
                {
					db.tbl_CUS_HRM_LIST_ChucDanh.Add(dbitem);
                    db.SaveChanges();
                ...
                {
					errorLog.logMessage("post_CUS_HRM_LIST_ChucDanh",e);
                    item = null;
                }
            }
            return item;
		...
		public static bool delete_CUS_HRM_LIST_ChucDanh(AppEntities db, int ID, string Username)
        {
			bool result = false;
            var dbitem = db.tbl_CUS_HRM_LIST_ChucDanh.Find(ID);
            if (dbitem != null)
            {
                ...
                {
					errorLog.logMessage("delete_CUS_HRM_LIST_ChucDanh",e);
                    result = false;
                }
            }
            return result;
		...
		public static bool check_CUS_HRM_LIST_ChucDanh_Exists(AppEntities db, int id)
		{
			return db.tbl_CUS_HRM_LIST_ChucDanh.Any(e => e.ID == id);
		}
		
		public static bool check_CUS_HRM_LIST_ChucDanh_Exists(AppEntities db, string Code)
		{
			return db.tbl_CUS_HRM_LIST_ChucDanh.Any(e => e.Code == Code);
		}
